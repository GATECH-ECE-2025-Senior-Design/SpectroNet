...
CPU_MODEL = "quantized2_mel_spectrogram_model.tflite"
...
# === Function to Process WAV Files and Run Inference ===
def process_wavs_and_run_inference():
    ...
    for i, wav_file in enumerate(wav_files):
        ...
        predicted_cpu, time_cpu, _ = run_inference(cpu_interpreter, data)
