...
# ACDS 23.1 993 win32 2025.03.21.01:01:58
# ----------------------------------------
...
# ----------------------------------------
# If complex_magnitude is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "complex_magnitude"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/complex_magnitude_memoryC0_uid193_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/complex_magnitude_memoryC1_uid196_sqrtTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/complex_magnitude_memoryC2_uid199_sqrtTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/complex_magnitude.vo"
}
