...
# ACDS 23.1 993 win32 2025.03.04.19:49:54
# ----------------------------------------
...
# ----------------------------------------
# If int_to_float is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "int_to_float"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/int_to_float.vo"
}
