...
# File: FACE.tcl
# Generated on: Tue Mar  4 20:06:22 2025
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "FACE"]} {
		puts "Project FACE is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists FACE]} {
		project_open -revision FACE FACE
	} else {
		project_new -revision FACE FACE
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name TOP_LEVEL_ENTITY DE10_Standard_golden_top
	set_global_assignment -name ORIGINAL_QUARTUS_VERSION 23.1STD.1
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "13:38:13  FEBRUARY 09, 2025"
	...
	set_global_assignment -name EDA_NATIVELINK_SIMULATION_TEST_BENCH face_top_tb -section_id eda_simulation
	set_global_assignment -name EDA_TEST_BENCH_NAME face_top_tb -section_id eda_simulation
	set_global_assignment -name EDA_DESIGN_INSTANCE_NAME NA -section_id face_top_tb
	set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME face_top -section_id face_top_tb
	set_global_assignment -name EDA_TEST_BENCH_FILE ../src/sim/face_top_tb.sv -section_id face_top_tb
	set_global_assignment -name EDA_MAP_ILLEGAL_CHARACTERS OFF -section_id eda_simulation
	set_global_assignment -name SIP_FILE ../src/ip/fft_512/simulation/fft_512.sip
	set_global_assignment -name SYSTEMVERILOG_FILE ../src/sim/face_top_tb.sv
	set_global_assignment -name VERILOG_FILE ../src/ip/pll_main.v -library pll_main
	set_global_assignment -name QIP_FILE ../src/ip/pll_main.qip
	set_global_assignment -name QSYS_FILE ../src/ip/fft_512.qsys
	set_global_assignment -name SYSTEMVERILOG_FILE ../src/rtl/face_top.sv
	set_global_assignment -name SDC_FILE ../src/constraints/clocks.sdc
	set_global_assignment -name SIP_FILE ../src/ip/pll_main.sip
	set_global_assignment -name VERILOG_FILE ../src/ip/adc_shiftreg.v
	set_global_assignment -name QIP_FILE ../src/ip/adc_shiftreg.qip
	set_global_assignment -name VERILOG_FILE ../src/ip/adc_fifo.v
	set_global_assignment -name VHDL_FILE ../src/rtl/i2c_oneshot_ctrl.vhd
	set_global_assignment -name VHDL_FILE ../src/rtl/i2c_master.vhd
	set_global_assignment -name SYSTEMVERILOG_FILE ../src/rtl/hex_disp.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../src/rtl/adc_interface.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../src/rtl/DE10_Standard_golden_top.sv
	set_global_assignment -name QIP_FILE ../src/ip/int_to_float.qip
	set_global_assignment -name SIP_FILE ../src/ip/int_to_float.sip
	set_global_assignment -name QIP_FILE ../src/ip/aud_data_buffer.qip
	...
	set_location_assignment PIN_G21 -to HPS_KEY
	set_location_assignment PIN_B17 -to HPS_LCM_BK
	set_location_assignment PIN_C18 -to HPS_LCM_D_C
	set_location_assignment PIN_E17 -to HPS_LCM_RST_N
	set_location_assignment PIN_A23 -to HPS_LCM_SPIM_CLK
	set_location_assignment PIN_C22 -to HPS_LCM_SPIM_MOSI
	set_location_assignment PIN_H20 -to HPS_LCM_SPIM_SS
