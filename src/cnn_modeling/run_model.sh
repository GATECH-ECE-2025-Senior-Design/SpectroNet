...
#SBATCH --mem-per-gpu=128GB              # Memory per CPU core, 8 CPUs/GPU 
#SBATCH -t5:00:00                        # Duration of the job (Ex: 1 hour) 
...
cd /home/hice1/jcochran66/code/AUDIO_MNIST_PRACTICE/src
srun --exclusive python run_cnn.py