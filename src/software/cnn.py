...
class Net(nn.Module):
    def __init__(self, num_classes=10):  # Assuming 10 output classes (can be changed)
        super(Net, self).__init__()

        # Convolutional Layer 1
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=3, stride=1, padding=1)  # Grayscale image (1 channel)
